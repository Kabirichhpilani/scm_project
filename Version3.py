...
class HangmanGame:
    ...
    def setup_game(self):
        ...
        self.category.set("Animals")  # Default category

        self.difficulty = tk.StringVar()
        self.difficulty.set("Easy")  # Default difficulty

        self.select_category = tk.OptionMenu(self.root, self.category, *self.word_list.keys())
        self.select_category.pack()

        self.select_difficulty = tk.OptionMenu(self.root, self.difficulty, "Easy", "Medium", "Hard")
        self.select_difficulty.pack()
    ...
    def start_game(self):
        self.select_category.pack_forget()
        self.select_difficulty.pack_forget()
        self.start_button.pack_forget()

        self.secret_word = random.choice(self.word_list[self.category.get()])
        self.guessed_letters = []
        self.num_guesses = 0
